...
$title = !empty($locality) ? "Doctor for Home Visit" . $dynamicLocality : $defaultTitle;
$description = "Looking for a doctor for a home visit" . $dynamicLocality . "? Our expert doctors provide fast and reliable healthcare services for elderly, bedridden, and chronic patients.";
$keywords = "doctor home visit" . ($dynamicLocality ? ", doctor home visit in " . htmlspecialchars($dynamicLocality, ENT_QUOTES, 'UTF-8') : "") .
            ", home healthcare, doctor on call" . ($dynamicLocality ? " in " . htmlspecialchars($dynamicLocality, ENT_QUOTES, 'UTF-8') : "") .
