    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-5 col-md-12 footer-info">
                <a href="index.php" class="logo d-flex align-items-center"><span>Doconnect</span></a>
                <p>
                    At Doconnect, we provide quality in-home medical care. Our services include doctor consultations, nebulisation, and more.
                </p>
            ...
            <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
                ...
                <p>
                    ...
                    We serve all over Mumbai<br><br>
...
<script src="https://cdn.tiny.cloud/1/tz909ejia2cbsck19u2hyuxplak77h1mtl4fi3etnqd06lg9/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
<script>
tinymce.init({
    selector: '#content', // Target textarea with ID 'post_content'
